...
public class AnalogClockView: UIView {
    ...
    override public func draw(_ rect: CGRect) {
        ...
        shapeLayer.fillColor = GMColor.imperialblue().cgColor
        // Set the border color to black
        shapeLayer.strokeColor = UIColor.white.cgColor
        // Set width of border
        shapeLayer.lineWidth = 2.0
        backgroundColor = GMColor.imperialblue()
        ...
        instanceLayerFat.backgroundColor = UIColor.white.cgColor
        ...
        instanceLayerThin.backgroundColor = UIColor.white.cgColor
    ...
    func color(){
        self.backgroundColor = GMColor.imperialblue()
    }
}
