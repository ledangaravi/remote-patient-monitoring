...
class GMColor {
    ...
    class func imperiallightblue() -> UIColor {
        return UIColor(rgb: 0x0091D4)
    }
    ...
    class func imperialorange() -> UIColor {
        return UIColor(rgb: 0xD24000)
    }

    class func lightBlue900Color() -> UIColor {
        return UIColor(rgb: 0x01579b)
    }
    class func imperialblue() -> UIColor {
        return UIColor(rgb: 0x003E74)
    }
